...
\[
   ...
   \begin{tikzpicture}[baseline=(b0.base), inner sep=1pt]
      \node (b0) {$X^{-1}$};
      \node[right=2.6em of b0] (b1) {$X^{-1}$};
      \draw (b0.west) -- ++(-.4,0);
      \draw (b0.east) .. controls +(.35,0) .. ++(.55,.4);
      \draw (b1.west) .. controls +(-.35,0) .. ++(-.55,.4);
      \draw (b1.east) -- ++(.4,0);
   \end{tikzpicture}
\]
...
\begin{walign}
   ...
   \begin{tikzpicture}[baseline=(a0.base), inner sep=1pt]
      ...
      \node[right=2.4em of a1] (a2) {$X^{-1}$};
      \node[right=.6em of a2] (a3) {$b$};
      \draw (a0) -- (a1);
      \draw (a1.east) .. controls +(.3,0) .. ++(.5,.4);
      \draw (a2.west) .. controls +(-.3,0) .. ++(-.5,.4);
      \draw (a2) -- (a3);
   \end{tikzpicture}
   \\
   \tag{63}
