...
\]
This notation follows Penrose~\cite{penrose1971}.
The two extra lines coming from the black dot on the circle make the derivative an order-5 tensor.
...
\begin{tikzpicture}[baseline=(T.base), inner sep=1pt]
   ...
   \draw (T) -- ++(-.5,+.1);
   \draw (T) -- ++(+.5,0);
   \draw[d] (T.east) .. controls +(80:.12) .. ++(-.2,.28);
   \draw[d] (T.east) .. controls +(45:.12) .. ++(.28,.18);
\end{tikzpicture}
\]

Before we dive into the tables, it is worth recording a simple observation that makes many of the identities below immediate.
A tensor network built purely from contractions is linear in each of the tensors it contains.
So if a tensor $X$ appears exactly once in a network $T$, the derivative $\frac{\partial T}{\partial X}$ is just \emph{the same network with the node $X$ deleted}, the edges that pointed into $X$ left dangling as the new derivative edges:
\[
   ...
   \end{tikzpicture}
\]
If $X$ appears $k$ times, the product rule simply sums the $k$ networks obtained by deleting one occurrence at a time --- we will see this repeatedly below, e.g.\ in (81) where $x$ appears twice.
Note that this is \emph{not} the chain rule: it only applies while nothing nonlinear stands between $T$ and $X$.
Once functions like $\exp$ or $\mathrm{softmax}$ enter the network, we need the machinery of Chapter~\ref{chapter:functions}.
...
Alternatively we could write $J^{i,j}_{k,l} = [i=k][j=l]$.
...
\begin{walign}
   ...
   &=
      \begin{tikzpicture}[baseline=(a0.base), inner sep=1pt]
         ...
         \path (a0) edge (a1);
         \path (a1) edge (a2);
         \draw[d] (a1.east) .. controls +(80:.12) .. ++(-.2,.28);
         \draw[d] (a1.east) .. controls +(45:.12) .. ++(.28,.18);
      \end{tikzpicture}
      =
      \begin{tikzpicture}[baseline=(a.base), inner sep=1pt]
         \node (a) {$a$};
   ...
   &
      \begin{tikzpicture}[baseline=(a0.base), inner sep=1pt]
         ...
         \draw (a0) -- (a1) -- (a2);
         \draw[d] (a2.east) .. controls +(80:.12) .. ++(-.2,.28) node[pos=1, anchor=south east, font=\tiny] {i};
         \draw[d] (a2.east) .. controls +(45:.12) .. ++(.28,.18) node[pos=1, anchor=west, font=\tiny] {j};
      \end{tikzpicture}
   &=
      \begin{tikzpicture}[baseline=(a.base), inner sep=1pt]
         \node (a) {};
   ...
   &
      \begin{tikzpicture}[baseline=(a0.base), inner sep=1pt]
         ...
         \draw[d] (a3.east) .. controls +(80:.12) .. ++(-.2,.28) node[pos=1, anchor=south east, font=\tiny] {m};
         \draw[d] (a3.east) .. controls +(45:.12) .. ++(.28,.18) node[pos=1, anchor=west, font=\tiny] {n};
      \end{tikzpicture}
   &=
      \begin{tikzpicture}[baseline=(a0.base), inner sep=1pt]
         \node (a0) {};
...
\begin{walign}
   ...
   \begin{tikzpicture}[baseline=.5em, inner sep=1pt]
      \node[copydot] (a0) at (0,0) {};
      \node (a1) at (.5,0) {$X$};
      \node[copydot] (a2) at (1,0) {};
      \path (a0) edge (a1);
      \path (a1) edge (a2);
      \node[copydot] (b0) at (0, .5) {};
      \node (b1) at (.5, .5) {$X$};
      \node[copydot] (b2) at (1, .5) {};
      \path (b0) edge (b1);
      \path (b1) edge (b2);
      \node at (-.25, .25) {$\bigg($};
      \node at (1.25, .25) {$\bigg)$};
      \draw[d] (1.35, .4) .. controls +(80:.12) .. ++(-.2,.28) node[pos=1, anchor=south east, font=\tiny] {i};
      \draw[d] (1.35, .4) .. controls +(45:.12) .. ++(.28,.18) node[pos=1, anchor=west, font=\tiny] {j};
   \end{tikzpicture}
   &=
   \begin{tikzpicture}[baseline=.5em, inner sep=1pt]
      \node[copydot] (a0) at (0,0) {};
      ...
      \path (b0) edge (b1);
      \path (b1) edge (b2);
      \draw[d] (.83,.0) .. controls +(80:.12) .. ++(-.2,.28);
      \draw[d] (.83,.0) .. controls +(45:.12) .. ++(.28,.18);
   \end{tikzpicture}
   +
   \begin{tikzpicture}[baseline=.5em, inner sep=1pt]
      \node[copydot] (a0) at (0,0) {};
      ...
      \path (b0) edge (b1);
      \path (b1) edge (b2);
      \draw[d] (0.83,.5) .. controls +(80:.12) .. ++(-.2,.28);
      \draw[d] (0.83,.5) .. controls +(45:.12) .. ++(.28,.18);
   \end{tikzpicture}
   %\\[.3em]
   \\
   &= 2\, \sum_{k,l} X_{k,l}
   ...
   \begin{tikzpicture}[baseline=(a0.base), inner sep=1pt]
      ...
      \draw[d] (a0.east) .. controls +(80:.12) .. ++(-.2,.28);
      \draw[d] (a0.east) .. controls +(45:.12) .. ++(.28,.18);
   \end{tikzpicture}
   &=
   \begin{tikzpicture}[baseline=(a0.base), inner sep=1pt]
      \node (a0) {$b$};
 ...
 \\&&&+
   ...
   \begin{tikzpicture}[baseline=(a0.base), inner sep=1pt]
      ...
      \draw[d] (a4.east) .. controls +(80:.12) .. ++(-.2,.28) node[pos=1, anchor=south east, font=\tiny] {i};
      \draw[d] (a4.east) .. controls +(45:.12) .. ++(.28,.18) node[pos=1, anchor=west, font=\tiny] {j};
   \end{tikzpicture}
   &=
   \begin{tikzpicture}[baseline=(a0.base), inner sep=1pt]
      \node (a0) {};
...
\begin{walign}
  ...
  \sum_{r=0}^{n-1}\left(\mathbf{X}^r \mathbf{J}^{i j} \mathbf{X}^{n-1-r}\right)_{k l}
   ...
   \begin{tikzpicture}[baseline=(X0.base), inner sep=1pt]
      ...
      \draw[d] (X4.east) .. controls +(80:.12) .. ++(-.2,.28) node[pos=1, anchor=south east, font=\tiny]{i};
      \draw[d] (X4.east) .. controls +(45:.12) .. ++(.28,.18) node[pos=1, anchor=west, font=\tiny]{j};
   \end{tikzpicture}
   \\
   &&&=\quad
   \begin{tikzpicture}[baseline=(X0.base), inner sep=1pt]
      ...
      \draw (X0) -- (X1) -- (X2) -- (X3) -- (X4);
      \draw (X4) -- ++(.5,0) node[midway, below right, font=\tiny] {l};
      \draw[d] (X0.east) .. controls +(80:.12) .. ++(-.2,.28) node[pos=1, anchor=south east, font=\tiny]{i};
      \draw[d] (X0.east) .. controls +(45:.12) .. ++(.28,.18) node[pos=1, anchor=west, font=\tiny]{j};
   \end{tikzpicture}
 \\&&&+\quad\dots
 \\&&&+\quad
   \begin{tikzpicture}[baseline=(X0.base), inner sep=1pt]
 ...
 \\
   ...
   \begin{tikzpicture}[baseline=(X0.base), inner sep=1pt]
      ...
      \draw (X0) -- (X3) -- (X4);
      \draw[d] (X4.east) .. controls +(80:.12) .. ++(-.2,.28);
      \draw[d] (X4.east) .. controls +(45:.12) .. ++(.28,.18);
   \end{tikzpicture}
   \\
   &&&=\quad
   \sum_{r=0}^{n-1}
...
\begin{walign}
   ...
   \begin{tikzpicture}[baseline=(a0.base), inner sep=1pt]
      ...
      \draw[d] (a3.east) .. controls +(80:.12) .. ++(-.2,.28);
      \draw[d] (a3.east) .. controls +(45:.12) .. ++(.28,.18);
   \end{tikzpicture}
   \hspace{-1em}
   &=
   \hspace{-2em}
 ...
 \\&&&
   ...
   \begin{tikzpicture}[baseline=(a0.base), inner sep=1pt]
      ...
      \draw[d] (a4.east) .. controls +(80:.12) .. ++(-.2,.28);
      \draw[d] (a4.east) .. controls +(45:.12) .. ++(.28,.18);
   \end{tikzpicture}
   &=
   \hspace{-1em}
   \begin{tikzpicture}[baseline=(a0.base), inner sep=1pt]
      ...
      \draw (a1) -- (a2) -- (a3);
      \path (a1) edge[out=160, in=20, looseness=1] (a3);
      \draw[d] (a2.south east) .. controls +(280:.12) .. ++(-.2,-.28);
      \draw[d] (a2.south east) .. controls +(315:.12) .. ++(.28,-.18);
   \end{tikzpicture}
 \\&&&=
   \hspace{-1em}
   \begin{tikzpicture}[baseline=(a0.base), inner sep=1pt]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 \\&
   ...
   \begin{tikzpicture}[baseline=(a0.base), inner sep=1pt]
      ...
      \draw (a1) -- (a2) -- (a3);
      \path (a1) edge[out=160, in=20, looseness=1] (a3);
      \draw[d] (a3.south east) .. controls +(280:.12) .. ++(-.2,-.28);
      \draw[d] (a3.south east) .. controls +(315:.12) .. ++(.28,-.18);
   \end{tikzpicture}
 \\&
   =(B+B^T)X
   &&=
...
In general one cannot push the substitution $X \to X^T$ through the derivative:
$\frac{\partial}{\partial X} f(X^T)$ is not simply
$\frac{\partial}{\partial X} f(X)$ with $X$ replaced by $X^T$.
%Instead we have
%\[
%   \frac{\partial}{\partial X} \mathrm{Tr}(X B X^T)
...
\begin{walign}
   ...
   \begin{tikzpicture}[baseline=(X0.base), inner sep=1pt]
      ...
      \draw[d] (X4.south east) .. controls +(280:.12) .. ++(-.2,-.28);
      \draw[d] (X4.south east) .. controls +(315:.12) .. ++(.28,-.18);
   \end{tikzpicture}
   \\
   &&&=\quad
 \sum_{r=0}^{n-1}
